...
2. **P0-B 生产 Runner 与真实 baseline**：√ 已完成（2026-09-19）。全量 1,000 篇索引 → Dev 扫描锁定 → Test 正式 run 全部执行，结果见 [`调参实录.md`](调参实录.md)：召回 88.2%→97.5%，引用正确率 96.7%，P95 2.3s。
...
3. **算法 P0-B / 评测 E1**：√ 已完成（2026-09-19）：全量索引、Dev 扫描锁定、Test baseline 均已真实执行，见 [`调参实录.md`](调参实录.md)。
